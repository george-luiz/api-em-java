...
@EqualsAndHashCode(of = "id") // Anotação para o Lombok gerar o Equals And Hash em cima do ID que foi passado como argumentos

public class Medico {

    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) // Gerar o ID automaticamente
    private long id;
    private String nome;
